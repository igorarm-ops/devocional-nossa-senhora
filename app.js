...
(function () {
  ...
  var KEY_NOME = "manto_esposa";
  var KEY_DIAS = "manto_dias_vividos";
  var KEY_LONGA = "manto_pref_longa";   // "1" = abrir reflexão profunda por padrão
  var KEY_ESCALA = "manto_escala";       // escala de fonte (0.9–1.4)
  ...
  function nomeEsposa() { return localStorage.getItem(KEY_NOME) || "meu esposo"; }
  function aplicarNome(txt) { return (txt || "").replace(/\{ESPOSO\}/g, nomeEsposa()); }
  ...
  function definirNome() {
    ...
    var nome = window.prompt("Como se chama o homem que você ama?\n(O nome dele aparece nos gestos e nas orações)", atual);
    if (nome === null) return;
    nome = nome.trim();
  ...
  var VAPID_PUBLIC = "BCq0SU2mYbjtN3xKD6rEzuMFNlRIcemV6elFNqRjfz5FPqaA2gpUJS7X7dVPvB9Y0svvmPOs4pU4WgOLQl88XJo";
  ...
  function ativarLembrete() {
    ...
    Notification.requestPermission().then(function (perm) {
      if (perm !== "granted") {
        msgLembrete("As notificações estão bloqueadas. Você pode liberar em Ajustes › Notificações › Maria, e tentar de novo.");
        return;
      }
